...
4. Состояние установки доходит до 100% несколько раз. Связано это с отдельной установкой и визуальным отображением каждого компонента. Время установки на слабых ПК составляет примерно 4 минуты.
